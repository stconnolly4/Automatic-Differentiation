...
differentiateTests =
  ...
  , [(  (Map.empty,DoubleE 5),
     ...
     (  ((Map.fromList [("x", VHat (ValueD 1) (DerivativeD 1)), ("y", VHat (ValueD 2) (DerivativeD 0))]),(PlusE (TimesE (DoubleE 17.2) (VarE (Var "x"))) (DoubleE 7))),
      ...
      ,
      ( ((Map.fromList [("x", VHat (ValueD 10) (DerivativeD 1))]), (SinE (VarE (Var "x")))),
            Just (VHat (ValueD (-0.5440211108893699)) (DerivativeD (-0.8390715290764524)))
      )
      ,
      ( ((Map.fromList [("x", VHat (ValueD 10) (DerivativeD 1))]), (CosE (VarE (Var "x")))),
            Just (VHat (ValueD (-0.8390715290764524)) (DerivativeD 0.5440211108893699))
      )
      ,
      ...
      ,
      ( ((Map.fromList [("x", VHat (ValueD 10) (DerivativeD 1)), ("y", VHat (ValueD 20) (DerivativeD 0))]), (PlusE (VarE (Var "x")) (VarE (Var "y")))),
            Just (VHat (ValueD 30.0) (DerivativeD 1.0))
      )
    ]
  )
